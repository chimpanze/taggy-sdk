...
type AddCollaboratorsRequestData = OpArgType<paths['/sharing/collections/{id}/collaborate']['post']>
type UpdatePermissionsRequestData = OpArgType<paths['/sharing/collections/{id}/permissions']['put']>
type UpdatePermissionsResponse = OpReturnType<paths['/sharing/collections/{id}/permissions']['put']>
...
export class SharingService extends BaseService {
   ...
   */
  async addCollaborators(id: string, data: AddCollaboratorsRequestData): Promise<Record<string, string>> {
    return this.post<'/sharing/collections/{id}/collaborate'>(`/sharing/collections/${id}/collaborate` as '/sharing/collections/{id}/collaborate', data);
  }
   ...
   */
  async updatePermissions(id: string, data: UpdatePermissionsRequestData): Promise<UpdatePermissionsResponse> {
    return this.put<'/sharing/collections/{id}/permissions'>(`/sharing/collections/${id}/permissions` as '/sharing/collections/{id}/permissions', data);
  }
   ...
   */
  async shareCollection(id: string, data: ShareCollectionRequestData): Promise<ShareCollectionResponse> {
    return this.post<'/sharing/collections/{id}/share'>(`/sharing/collections/${id}/share` as '/sharing/collections/{id}/share', data);
  }
  ...
  async acceptInvitation(id: string): Promise<AcceptInvitationResponse> {
    return this.post<'/sharing/invitations/{id}/accept'>(`/sharing/invitations/${id}/accept` as '/sharing/invitations/{id}/accept');
  }
  ...
  async declineInvitation(id: string): Promise<DeclineInvitationResponse> {
    return this.post<'/sharing/invitations/{id}/decline'>(`/sharing/invitations/${id}/decline` as '/sharing/invitations/{id}/decline');
  }
  ...
  async getPublicShare(shareId: string): Promise<GetPublicShareResponse> {
    return this.get<'/sharing/public/{shareId}'>(`/sharing/public/${shareId}` as '/sharing/public/{shareId}');
  }
  ...
  async shareTag(id: string, data: ShareTagRequestData): Promise<ShareTagResponse> {
    return this.post<'/sharing/tags/{id}/share'>(`/sharing/tags/${id}/share` as '/sharing/tags/{id}/share', data);
  }
